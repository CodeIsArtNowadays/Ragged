...
class ChannelModel(Base):
    ...
    workspace: Mapped['WorkspaceModel'] = relationship('WorkspaceModel', back_populates='channel') # noqa: F821  # ty:ignore[unresolved-reference]
...
class MessageModel(Base):
    ...
    author: Mapped['MemberModel'] = relationship('MemberModel', back_populates='messages') # noqa: F821  # ty:ignore[unresolved-reference]
